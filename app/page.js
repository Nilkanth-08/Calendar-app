...
export default function Home() {
    ...
    if(draggableEl){
      new Draggable(draggableEl, {
        ...
        eventData: function(eventEl){
          ...
          return {title: title, id: id, duration: {days:1}};
      }
    });
  }
},[]);
  ...
  return (
    ...
    <nav className="flex justify-between mb-12 border-b border-gray-300 border-shadow p-3">
      <h1 className="font-bold text-2x1 text-gray-800">Calendar App</h1>
    </nav>
    <select
        value={timezone}
    ...
    <main className="flex flex-wrap items-start justify-center box-shadow: 5px 2px 2px #eee p-5">
      <div className="flex flex-col justify-space between">
          ...
          headerToolbar={{
            ...
            center: 'title',
            right: 'timeZoneSelect dayGridMonth,timeGridWeek,timeGridDay'
          }}
          events={allEvents}
          nowIndicator={true}
          editable={true}
        ...
        <div id="draggable-el" className="ml-8 w-full border-2 p-2 rounded-md mt-16 lg:h-1/2 bg-violet-50">
            <h1 className="font-bold text-lg text-center">ADD YOUR TASK</h1>
            {events.map(event => (
              <div
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <form action="submit" onSubmit={handleSubmit}>
                          <div className="mt-2">
                            <input type="text" name="title" className="block w-full rounded-md border-0 
                          ...
                          <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                            <button
                              type="submit"
                              className="inline-flex w-full justify-center rounded-md bg-violet-600 px-3 
